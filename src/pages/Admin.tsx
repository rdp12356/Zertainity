...
const Admin = () => {
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="shadow-card w-full max-w-md">
          ...
          <CardContent className="space-y-4">
            <Button onClick={() => navigate("/auth")} className="w-full" variant="default" size="lg">
              Sign In
            </Button>
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Zertainity Admin Dashboard</title>
        <meta name="robots" content="noindex, nofollow" />
      </Helmet>
      <header className="border-b border-border/50 bg-card/50 backdrop-blur-md sticky top-0 z-10 transition-colors duration-300">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 border-l border-border/50 pl-4 text-foreground">
            ...
            <Button variant="outline" size="sm" className="font-medium" onClick={handleLogout}>Logout</Button>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        <Tabs defaultValue="colleges" className="w-full">
          <TabsList className="grid w-full grid-cols-3 md:grid-cols-7 mb-8 bg-muted/50 p-1 border border-border/50 h-auto gap-1">
            <TabsTrigger value="colleges" className="data-[state=active]:bg-background data-[state=active]:shadow-sm py-2">Colleges</TabsTrigger>
            <TabsTrigger value="schools" className="data-[state=active]:bg-background data-[state=active]:shadow-sm py-2">Schools</TabsTrigger>
            <TabsTrigger value="users" onClick={() => fetchUsers()} className="data-[state=active]:bg-background data-[state=active]:shadow-sm py-2">Users</TabsTrigger>
            <TabsTrigger value="permissions" className="data-[state=active]:bg-background data-[state=active]:shadow-sm py-2">Permissions</TabsTrigger>
            <TabsTrigger value="activity" onClick={() => fetchActivityLogs()} className="data-[state=active]:bg-background data-[state=active]:shadow-sm py-2">Activity</TabsTrigger>
            <TabsTrigger value="audit" onClick={() => fetchAuditLogs()} className="data-[state=active]:bg-background data-[state=active]:shadow-sm py-2">Audit Trail</TabsTrigger>
            <TabsTrigger value="settings" className="data-[state=active]:bg-background data-[state=active]:shadow-sm py-2">Settings</TabsTrigger>
          </TabsList>
