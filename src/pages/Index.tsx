...
const Index = () => {
  ...
  const features = [
    ...
    { icon: Sparkles, title: "Career Insights", description: "Discover trends and detailed information about different career fields.", color: "from-amber-500 to-orange-400", glow: "group-hover:shadow-amber-500/25" },
  ];
  ...
  const tools = [
    ...
    { icon: Zap, label: "Exam Finder", path: "/exam-finder", color: "bg-gradient-to-br from-cyan-400 to-sky-600" },
  ];
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {isAuthenticated ? (
                <Button variant="outline" size="sm" onClick={() => navigate("/dashboard")} className="rounded-full px-5 font-medium hover:scale-105 transition-transform">
