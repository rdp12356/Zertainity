...
const AnalysisHistory = () => {
    ...
    return (
        <div className="min-h-screen bg-background">
            <PageSEO
                title="Your Career Analysis History"
                description="Review your past career assessments and AI-powered recommendations."
                canonical="/history"
            />
            <header className="border-b border-border bg-card sticky top-0 z-10 shadow-sm">
                <div className="container mx-auto px-4 py-4 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold leading-none bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">Analysis History</h1>
                        <p className="text-xs text-muted-foreground">Your past career assessments</p>
                    </div>
                </div>
            </header>
