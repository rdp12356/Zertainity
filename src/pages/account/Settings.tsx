  ...
  return (
    <div className="min-h-screen bg-background">
      <PageSEO
        ...
        description="Customize your account experience, profile details, and theme settings."
        canonical="/settings"
      />
      <header className="border-b border-border bg-card sticky top-0 z-50 shadow-sm backdrop-blur-xl">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold leading-none bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">Settings</h1>
              <p className="text-xs text-muted-foreground">Account & Personalization</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <ThemeToggle />
            <Button variant="outline" size="sm" onClick={handleSignOut} className="rounded-full shadow-sm">
