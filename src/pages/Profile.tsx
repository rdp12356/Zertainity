...
const Profile = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-muted/30">
            <PageSEO
                title="Your Profile"
                description="Manage your personal information, contact details, and career preferences on Zertainity."
                canonical="/profile"
            />
            <header className="border-b border-border bg-card sticky top-0 z-50 shadow-sm backdrop-blur-xl">
                <div className="container mx-auto px-4 py-4 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold leading-none bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">Profile</h1>
