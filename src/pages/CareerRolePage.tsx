...
const CareerRolePage = () => {
  ...
  const articleSchema = {
    ...
    author: [
      { "@type": "Person", name: "Johan Manoj", url: "https://www.zertainity.in/about" },
      { "@type": "Organization", name: "Zertainity", url: "https://www.zertainity.in" },
    ],
    publisher: {
      "@type": "Organization",
      name: "Zertainity",
    ...
    dateModified: "2026-08-22T00:00:00+05:30",
