      ...
      <header className="border-b border-border bg-card shadow-card">
        <div className="container mx-auto px-4 py-6">
          <div className="container mx-auto px-4 py-4 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold leading-none bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">Career Pathways</h1>
              <p className="text-xs text-muted-foreground">Roadmaps from school to job</p>
            </div>
          </div>
        </div>
      </header>
