            ...
            <div className="space-y-4">
              ...
              <div className="w-full max-w-sm">
                <button
                  ...
                  disabled={loading}
                  className="h-11 w-full rounded-lg border border-border/60 bg-background hover:bg-muted/40 text-sm font-medium flex items-center justify-center gap-2 transition-all active:scale-[0.98] disabled:opacity-60"
                >
